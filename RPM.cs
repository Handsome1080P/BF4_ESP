...
namespace PZ_BF4
{
    class RPM
    {
        ...
        public static Int64 ReadInt64(Int64 _lpBaseAddress)
        {
            ...
            IntPtr ByteRead;
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 8, out ByteRead);
        ...
        public static Int32 ReadInt32(Int64 _lpBaseAddress)
        {
            ...
            IntPtr ByteRead;
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 4, out ByteRead);
        ...
        public static float ReadFloat(Int64 _lpBaseAddress)
        {
            ...
            IntPtr ByteRead;
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, sizeof(float), out ByteRead);
        ...
        {
            uint oldProtect;
            NativeMethods.VirtualProtectEx(pHandle, (IntPtr)MemoryAddress, (uint)Buffer.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out oldProtect);
            IntPtr ptrBytesWritten;
            return NativeMethods.WriteProcessMemory(pHandle, MemoryAddress, Buffer, (uint)Buffer.Length, out ptrBytesWritten);
        }
        ...
        public static byte ReadByte(Int64 _lpBaseAddress)
        {
            ...
            IntPtr ByteRead;
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, sizeof(byte), out ByteRead);
            return Buffer[0];
        }
        ...
        public static string ReadName(Int64 address, UInt64 _Size)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, address, buffer, _Size, out BytesRead);
        ...
        public static string ReadString(Int64 _lpBaseAddress, UInt64 _Size)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, buffer, _Size, out BytesRead);
        ...
        public static Vector3 ReadVector3(Int64 _lpBaseAddress)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 12, out ByteRead);
            tmp.X = BitConverter.ToSingle(Buffer, (0 * 4));
            tmp.Y = BitConverter.ToSingle(Buffer, (1 * 4));
        ...
        public static AxisAlignedBox ReadAABB(Int64 _lpBaseAddress)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 32, out ByteRead);
        ...
        public static Vector4 ReadVector4(Int64 _lpBaseAddress)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 16, out ByteRead);
            tmp.X = BitConverter.ToSingle(Buffer, (0 * 4));
            tmp.Y = BitConverter.ToSingle(Buffer, (1 * 4));
            tmp.Z = BitConverter.ToSingle(Buffer, (2 * 4));
        ...
        public static Matrix ReadMatrix(Int64 _lpBaseAddress)
        {
            ...
            NativeMethods.ReadProcessMemory(pHandle, _lpBaseAddress, Buffer, 64, out ByteRead);
